...
// Что реализовано/не реализовано(т.е. в разработке):
Интерфейс приложения, и чтение данных из базы реализованы полностью. Все компоненты снабжены всплывающими подсказками. Всего имеется 3 вкладки.
